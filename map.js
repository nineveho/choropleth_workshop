async function createMap() {
  ...
  mapboxgl.accessToken =
    "pk.eyJ1IjoibmluZXZlaG9tYXAiLCJhIjoiY2w5d3R3NHVrMDBqZDNxcWxrMGt3Y21wMSJ9.F3_lqP-kbMq1X8N-xVWrlg";
  const map = new mapboxgl.Map({
    container: "map", // Container ID
    style: "mapbox://styles/ninevehomap/cl9wu1pdd002p15s583ifqru9", // Map style to use
    projection: "globe",
